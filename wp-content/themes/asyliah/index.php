...
<form action="#" method="post"></form>
    <div class="container">
        ...
        <div class="box" id="box3">
            <img src="http://localhost/wordpress/wp-content/uploads/2024/09/drag.gif" alt="Image 2" class="image">
            <button type="submit" class="submit-button" id="button3">Submit 3</button>
        </div>
    </div>
</form>
